...
from nns.tsl_layers.SelfAttention_Family import TwoStageAttentionLayer
...
class scale_block(nn.Module):
    def __init__(self, output_attention, win_size, d_model, n_heads, d_ff, depth, dropout, seg_num=10, factor=10):
        ...
        for i in range(depth):
            self.encode_layers.append(TwoStageAttentionLayer(output_attention, seg_num, factor,
